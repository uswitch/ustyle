  ...
  <div id="wrapper">
    ...
    <div class="styleguide container sidebar--push">
      ...
      <div class="us-content-group">
        ...
        <div class="us-grid-row">
          <div class="us-col-md-8">
            <p>Our product and object focused imagery may be cut out over our brand colours, brand gradients or white. When objects aren’t cut out, they should be realistic in their setting and not appear staged. Images should be straightforward, not overly metaphor based, and should not appear noticeably manipulatd. Images should be ‘documentary’ in style, avoiding cheesy, posed, forced or unrealistic photography. 
