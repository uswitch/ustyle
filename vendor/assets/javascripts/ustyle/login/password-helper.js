...
(function($, window, document) {
  ...
  return PasswordHelper = (function() {
    ...
    PasswordHelper.prototype.strengthChecker = function() {
      var html, strengthMeter, strengthTest;
      html = "<div class='" + this.options.classPrefix + "__meter'>";
      html += "<div class='" + this.options.classPrefix + "__meter-bar' /></div>";
      this.$el.after($(html));
      strengthMeter = $("." + this.options.classPrefix + "__meter-bar");
      strengthTest = (function(_this) {
    ...
    PasswordHelper.prototype.showHide = function() {
      var exp, showClass;
      exp = "<a class='" + this.options.classPrefix + "__show-hide' />";
      this.$el.after($(exp).text(this.options.showText));
      showClass = this.options.classPrefix + "__input--pass-shown";
    ...
    createWrapper = function(el, classPrefix) {
      var wrapper, wrapperCss;
      wrapperCss = {
        position: 'relative',
        height: el.css('height'),
        display: el.css('display')
      };
      return wrapper = el.wrap($("<div />").addClass(classPrefix + "__wrapper").css(wrapperCss));
    };
